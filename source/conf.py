...
copyright = u'2010 – 2012, Michael Markert et al'
...
html_title = "Das Python%s-Tutorial auf Deutsch" % version
...
htmlhelp_basename = 'python-tutorial-de'
...
latex_documents = [
  ('index', 'python-tutorial.tex', u'Python%s-Tutorial auf Deutsch' % version,
